		...
		<div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-4 offset-sm-1">
                        <h5>Our Address</h5>
                        <address>
                        	111, Tweet Boys Bay Back<br />
			              	Fine Boys Bay, Where<br />
			              	HONG KONG<br />
                        <i className="fa fa-phone"></i>: +111 1234 5678<br />
                        <i className="fa fa-fax"></i>: +111 8765 4321<br />
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        <a role="button" className="btn btn-primary" href="tel:+11112345678"><i className="fa fa-phone"></i> Call</a>
